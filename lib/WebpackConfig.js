...
class WebpackConfig {
    ...
    configureOutput(configureOutputCallback = () => {}) {
        if (typeof(configureOutputCallback) !== 'function') {
            throw new Error('Argument 1 to configureOutput() must be a callback function.');
        }

        this.configureOutputCallback = configureOutputCallback;
    }
